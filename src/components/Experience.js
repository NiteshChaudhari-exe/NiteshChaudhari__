...
const timeline = [
    {
        ...
        period: '2023 - Present',
        description: 'Pursuing a Bachelor of Technology degree with a focus on software development and computer systems.',
        achievements: [
            'Leading the self coding activities',
            'Secured internship at Tech Company Inc.',
    ...
    },
    {
        type: 'education',
        title: '+2 College',
        organization: 'Capital College and Research Centre (CCRC)',
        location: 'kathmandu, Nepal',
        period: '2021 - 2023',
        description: 'Focused on computer science and mathematics, laying a strong foundation for advanced studies in technology.',
        achievements: [
            'Graduated with First Division honors',
            'Participated in coding competitions and hackathons',
            ' Volunteered as a tech tutor for peers',
        ],
    },
    {
        type: 'education',
        title: 'Secondary Education Examination (S.E.E)',
        organization: 'Sagarmatha Secondary School',
        location: 'Biratnagar, Nepal',
        period: '2017 - 2021',
        description: 'Focused on software engineering, algorithms, and web technologies.',
        achievements: [
            'GPA: 3.9/4.0',
            'Top sportman in inter-school sports competition',
